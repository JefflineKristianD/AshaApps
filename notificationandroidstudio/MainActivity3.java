...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(view2 -> {
            Intent intent2 = new Intent(MainActivity3.this, com.firebase.notificationandroidstudio.MainActivity2.class);
            startActivity(intent2);
        });

        Button btn3 = findViewById(R.id.secondActivityButton3);
        btn3.setOnClickListener(view3 -> {
            Intent intent3 = new Intent(MainActivity3.this, com.firebase.notificationandroidstudio.MainActivity3.class);
        ...
        btn5.setOnClickListener(view5 -> {
            Intent intent5 = new Intent(MainActivity3.this, com.firebase.notificationandroidstudio.MainActivity5.class);
            startActivity(intent5);
        });

        Button btn6 = findViewById(R.id.secondActivityButton6);
        btn6.setOnClickListener(view6 -> {
            Intent intent6 = new Intent(MainActivity3.this, MainActivity6.class);
